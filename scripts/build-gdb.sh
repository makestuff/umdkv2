...
rm -rf gdb-7.7 gdb-7.7-ms1
bunzip2 -c gdb-7.7.tar.bz2 | tar xf -
mv gdb-7.7 gdb-7.7-ms1

patch gdb-7.7-ms1/gdb/remote.c <<EOF
--- gdb-7.7-old/gdb/remote.c	2014-02-06 02:21:29.000000000 +0000
+++ gdb-7.7-new/gdb/remote.c	2014-03-21 11:31:52.633615044 +0000
@@ -7367 +7367 @@
-	      if (tcount > 3)
+	      //if (tcount > 3)
EOF

patch gdb-7.7-ms1/gdb/m68k-tdep.c <<EOF
--- gdb-7.7-old/gdb/m68k-tdep.c	2014-01-08 09:23:36.000000000 +0000
+++ gdb-7.7-new/gdb/m68k-tdep.c	2014-03-21 11:29:10.017290964 +0000
@@ -166 +166 @@
-    "ps", "pc",
+    "sr", "pc",
EOF

patch gdb-7.7-ms1/gdb/regformats/reg-m68k.dat <<EOF
--- gdb-7.7-old/gdb/regformats/reg-m68k.dat	2003-01-04 21:55:53.000000000 +0000
+++ gdb-7.7-new/gdb/regformats/reg-m68k.dat	2011-06-12 19:23:29.597109001 +0100
@@ -19 +19 @@
-32:ps
+32:sr
EOF

patch gdb-7.7-ms1/opcodes/m68k-dis.c <<EOF
--- gdb-7.7-old/opcodes/m68k-dis.c	2010-06-16 16:12:49.000000000 +0100
+++ gdb-7.7-new/opcodes/m68k-dis.c	2011-06-13 21:14:07.389109000 +0100
@@ -41,3 +41,3 @@
...
+      } else {
+	// Some other base reg
+	(*info->fprintf_func) (info->stream, "%du(%s", (unsigned int)disp, reg_names[regno]);
+      }
@@ -531 +536 @@
...
patch gdb-7.7-ms1/opcodes/m68k-opc.c <<EOF
--- gdb-7.7-old/opcodes/m68k-opc.c	2013-12-08 04:11:52.000000000 +0000
+++ gdb-7.7-new/opcodes/m68k-opc.c	2014-03-21 11:17:42.463889464 +0000
@@ -42,2 +42,2 @@
...
static void print_address(bfd_vma addr, struct disassemble_info *info) {
	(*info->fprintf_func)(info->stream, "0x%X", (unsigned int)addr);
}
